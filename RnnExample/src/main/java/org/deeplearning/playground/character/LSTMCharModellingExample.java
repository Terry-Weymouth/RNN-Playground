package org.deeplearning.playground.character;
...
/**LSTM Character modeling example
 * @author Alex Black
...
public class LSTMCharModellingExample {
	public static void main( String[] args ) throws Exception {
		...
		String generationInitialization = "To be, or not to be. That is the question.";		//Optional character initialization; a random character is used if null
		...
		System.out.println("Number of inputs: " + iter.inputColumns());
		System.out.println("Size of middle layers: " + lstmLayerSize);
		System.out.println("Number of outputs: " + nOut);
	...
	public static CharacterIterator getShakespeareIterator(int miniBatchSize, int sequenceLength) throws Exception{
		...
		String fileLocation = "/Volumes/Data1/Deeplearning4j/Shakespeare.txt";		//Storage (local) location from downloaded file
		File f = new File(fileLocation);
		if( !f.exists() ) {
			String tempDir = System.getProperty("java.io.tmpdir");
			fileLocation = tempDir + "/Shakespeare.txt";			//Storage location from downloaded file
